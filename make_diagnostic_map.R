make_diagnostic_map <- function(data, polygon, study_border, outcome, treat,
  ...
  #create a grid to project predictions across space
  ...
  #define treatment and xy coordinates for projected grid
  ...
  #if the researcher DOES NOT wants the impact of lat-lon coords to vary across 
  ...
  #if the researcher DOES want the impact of lat-lon coords to vary across 
  #treatment and control areas
  else{
    #fit the variogram 
